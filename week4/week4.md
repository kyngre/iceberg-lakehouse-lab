...
---
올려주신 실제 코드를 보니, 강사님께서 골드 레이어에 **CTR(클릭률), CVR(전환률), CPA(전환당 비용)** 같은 핵심 마케팅 지표를 직접 계산하는 로직까지 아주 디테일하게 구현해 두셨네요!

이 코드 내용을 완벽하게 반영하여 과제 제출용 마크다운 양식을 다시 작성해 드립니다. 이 양식을 그대로 복사해서 과제에 사용하시면 됩니다.
